...
# Load models===========================================================================================================
rf_classifier_categorization = pickle.load(open('modules/rf_classifier_categorization.pkl', 'rb'))
tfidf_vectorizer_categorization = pickle.load(open('modules/tfidf_vectorizer_categorization.pkl', 'rb'))
rf_classifier_job_recommendation = pickle.load(open('modules/rf_classifier_job_recommendation.pkl', 'rb'))
tfidf_vectorizer_job_recommendation = pickle.load(open('modules/tfidf_vectorizer_job_recommendation.pkl', 'rb'))
...
def extract_name_from_resume(text):
    ...
    candidate_lines = lines[:10]  # Only look at top 10 lines

    skip_keywords = [
        'career', 'objective', 'summary', 'email', 'gmail', 'outlook',
        'linkedin', 'github', 'phone', 'contact', 'education', 'last updated',
        'update', '.com', 'www.', 'http', 'resume', '@'
    ]
    ...
    for line in candidate_lines:
        ...
        # Check if line contains 2+ words that look like a name
        if len(line_clean.split()) >= 2 and line_clean.replace(" ", "").isalpha():
            return line_clean  # Accept even lowercase or mixed-case names
